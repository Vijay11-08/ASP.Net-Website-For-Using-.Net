...
{
    public partial class IphoneChargerDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("IphoneChargers.aspx"); // Redirect if no model is specified
            }
        }
        ...
        private void LoadChargerDetails(string model)
        {
            switch (model.ToLower())
            {
                case "lightningusbc":
                    ...
                    chargerImage.ImageUrl = "Image/i_charger.jpg"; // Ensure the correct image path is provided
                    break;
