...
{
    public partial class XiaomiChargerDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("XiaomiChargers.aspx"); // Redirect if no model is specified
            }
        }
        ...
        private void LoadChargerDetails(string model)
        {
            switch (model.ToLower())
            {
                case "lightningusbc":
                    ...
                    chargerImage.ImageUrl = "Image/x_charger.jpg"; // Ensure the correct image path is provided
                    break;
