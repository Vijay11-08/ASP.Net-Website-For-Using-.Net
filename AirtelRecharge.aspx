<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="AirtelRecharge.aspx.cs" Inherits="NetWebsite.AirtelRecharge" %>
        ...
        <table class="plans-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>₹479</td>
                    <td>
                        <button class="add-to-cart-btn" onclick="addToCart('₹479', '2GB/Day Plan')">Add to Cart</button>
                    </td>
                </tr>
                <tr>
                    <td>3GB/Day Plan</td>
