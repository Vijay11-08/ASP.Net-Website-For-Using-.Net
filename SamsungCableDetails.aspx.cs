...
{
    public partial class SamsungCableDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("SamsungCables.aspx"); // Redirect if no model is specified
            }
        }
        ...
        private void LoadCableDetails(string model)
        {
            switch (model.ToLower())
            {
                case "lightningusbcable":
                    ...
                    cablePrice.Text = "$19";
                    cableImage.ImageUrl = "Image/s_cable.jpg"; // Ensure you have the correct image path
                    break;
