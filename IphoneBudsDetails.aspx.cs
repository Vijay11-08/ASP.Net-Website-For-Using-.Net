...
{
    public partial class IphoneBudsDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("IphoneBuds.aspx"); // Redirect if no model is specified
            }
        }
        ...
        private void LoadBudsDetails(string model)
        {
            switch (model.ToLower())
            {
                case "airpodspro":
                    ...
                    budsPrice.Text = "$249";
                    budsImage.ImageUrl = "Image/i_buds.jpg"; // Ensure you have the correct image path
                    break;
