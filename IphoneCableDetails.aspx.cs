...
{
    public partial class IphoneCableDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("IphoneCables.aspx"); // Redirect if no model is specified
            }
        }
        ...
        private void LoadCableDetails(string model)
        {
            switch (model.ToLower())
            {
                case "lightningusbcable":
                    ...
                    cablePrice.Text = "$19";
                    cableImage.ImageUrl = "Image/i_cable.jpg"; // Ensure you have the correct image path
                    break;
