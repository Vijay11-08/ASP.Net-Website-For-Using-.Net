...
{
    public partial class SamsungBudsDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("SamsungBuds.aspx"); // Redirect if no model is specified
            }
        }
        ...
        private void LoadBudsDetails(string model)
        {
            switch (model.ToLower())
            {
                case "airpodspro":
                    ...
                    budsPrice.Text = "$249";
                    budsImage.ImageUrl = "Image/s_buds.jpg"; // Ensure you have the correct image path
                    break;
