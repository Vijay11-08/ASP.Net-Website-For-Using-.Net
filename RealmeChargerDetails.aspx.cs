...
{
    public partial class RealmeChargerDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("RealmeChargers.aspx"); // Redirect if no model is specified
            }
        }
        ...
        private void LoadChargerDetails(string model)
        {
            switch (model.ToLower())
            {
                case "lightningusbc":
                    ...
                    chargerImage.ImageUrl = "Image/r_charger.jpg"; // Ensure the correct image path is provided
                    break;
